		...
		const projects = ref<Project[]>([
			{
				...
				description:
					'A free URL shortener service that allows you to easily shorten long URLs into shorter, more manageable links.',
			...
			},
			{
				...
				description:
					'A serverless Cloudflare Worker that parses incoming emails, saves the email body and attachments to an R2 bucket, and provides a JSON feed accessible through a GET request.',
			...
			},
			{
				...
				category: 'Web Development',
				description:
					'A real-time visitor counter built using Vue 3, Vite, Cloudflare Durable Objects, and WebSockets, organized within a Turbo Monorepo.',
			...
			},
			{
				...
				description:
					'A Discord music bot that plays music from YouTube with real-time search results, queue management, and more.',
			...
			},
			{
				...
				category: 'Personal',
				description:
					'An archive of my old websites, showcasing my journey in web development and design back in high school.',
				cover: '/gallery/lilya.jpg',
