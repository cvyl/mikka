...
export default defineComponent({
		...
		const loadPost = async () => {
			...
			if (matchedPath) {
				try {
					...
					postHTML.value = marked(contentWithoutFrontmatter)
					updateTOC()
				} catch (error) {
					router.push('/')
				}
    ...
    watch([title, description, cover, route.params.slug, tags], () => {
      if (title.value && route.params.slug) {
        useHead({
          title: title.value,
          link: [
        ...
        useHead({
          ...
          meta: [
            { name: 'description', content: 'cvyl 的个人博客' },
            { property: 'og:url', content: 'https://cvyl.me/blog' },
            { property: 'og:title', content: 'cvyl\'s Blog' },
            { property: 'og:description', content: 'cvyl 的个人博客' },
            { property: 'twitter:title', content: 'cvyl\'s Blog' },
            { property: 'twitter:description', content: 'cvyl 的个人博客' }
          ]
        })
      }
    }, { immediate: true })
